	...
	const presets: { label: string; tasks: ReturnType<typeof mt>[] }[] = [
		{
			...
			tasks: (() => {
				...
				return [
					...
					mt('レポート提出', '経済学のレポート。3000字以上', '2026-05-09T00:00:00.000Z', 'high', '大学'),
		...
		},
		{
			...
			tasks: (() => {
				...
				return [
					...
					mt('歯医者の予約', '', '2026-05-22T00:00:00.000Z', 'medium', '健康'),
					mt('本を返却', '図書館の返却期限', '2026-05-25T00:00:00.000Z', 'low', 'その他'),
